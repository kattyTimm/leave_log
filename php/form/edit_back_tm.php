        <div class="modal fade" id="edit_back_tm" tabindex="-1" role="dialog" aria-labelledby="fm_clnf_ttl" aria-hidden="true" ondrop="return false;" ondragover="return false;"
             data-rid="" >
                ...
                <div class="modal-content y-modal-shadow">
                    ...
                    <div class="modal-body">
                        <form role="form" autocomplete="off" onsubmit="return false">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <small><label for="back_time_edit">Прибыл: </label></small>
                                    <input id="back_time_edit" class="form-control" type="text" ondrop="return false;" ondragover="return false;">
                                </div>
                    ...
                    <div class="modal-footer y-modal-footer-bk">
                        ...
                        <button id="back_tm_ok" class="btn btn-primary y-shad">Ok</button>
                    </div>
                </div>
            </div>
        </div>