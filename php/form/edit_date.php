        <div class="modal fade" id="edit_date" tabindex="-1" role="dialog" aria-labelledby="fm_clnf_ttl" aria-hidden="true" ondrop="return false;" ondragover="return false;"
             data-rid="" >
                ...
                <div class="modal-content y-modal-shadow">
                    ...
                    <div class="modal-body">
                        <form role="form" autocomplete="off" onsubmit="return false">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <small><label for="date_edit">Дата: </label></small>
                                    <input id="date_edit" class="form-control" type="text" ondrop="return false;" ondragover="return false;">
                                </div>
                                 <div class="col-12 y-fz08 text-primary">
                                    <span class="text-primary">Отредактируйте дату</span><br>
                    ...
                    <div class="modal-footer y-modal-footer-bk">
                        ...
                        <button id="date_ok" class="btn btn-primary y-shad">Ok</button>
                    </div>
                </div>
            </div>
        </div>